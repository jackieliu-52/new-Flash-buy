 ...
 */
public class NestedScrollingListView2 extends ListView implements NestedScrollingChild {
    private NestedScrollingChildHelper mNestedScrollingChildHelper;

    public NestedScrollingListView2(final Context context) {
        super(context);
        initHelper();

    }

    public NestedScrollingListView2(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        initHelper();
    }

    public NestedScrollingListView2(final Context context, final AttributeSet attrs, final int defStyleAttr) {
